...
**Status:** Building — sessions 1–4 done; session 5 built and verified offline, **done-when open until it is deployed and Chris scores one session blind** (37 Chris statements from the 9/18 call still pending his approval); next is 6
**Owner:** Mark Anderson
