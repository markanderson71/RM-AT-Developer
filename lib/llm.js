...
export async function complete({ model, system, user, maxTokens = 4000, temperature = 0, budgetMs = null, _client: injected }) {
  budgetMs ??= Number(process.env.LLM_BUDGET_MS) > 0 ? Number(process.env.LLM_BUDGET_MS) : CALL_BUDGET_MS;
