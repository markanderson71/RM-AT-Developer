...
import { has, connectionStats, renderChains, comparisonFacts, dirtFacts } from '../extractStats.js';
...
export async function extractSession(session) {
  ...
  dirtFacts(out);                                                   // code-computed; re-applied on --reuse
