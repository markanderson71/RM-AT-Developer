...
function ingestAssessmentForm(file, text, log) {
  const CRIT_TAGS = {
    ...
    'Prescription': ['prescription'], 'Equipment': ['prescription', 'general'],
    'Understanding of Desired Performances': ['describe', 'evaluate'], 'Understanding of Biomechanics/Physics': ['biomechanics'],
...
const STRATEGIES = [
  ...
  { match: /^at-ma-tu-assessment-form/, run: (f, t, l) => ingestAssessmentForm(f, t, l) },
