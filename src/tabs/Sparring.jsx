 ...
 */
export default function Sparring({ maSessions, mentorAssessments, referenceText, onSaved }) {
  return (
    <>
      ...
      <Card style={{ borderLeft: `3px solid ${C.exam}` }}>
        ...
        <ATExam maSessions={maSessions} mentorAssessments={mentorAssessments} referenceText={referenceText} onSaved={onSaved} />
      </Card>
    </>
  );
}
